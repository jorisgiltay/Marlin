...
## Changed to accomodate Root 3 CNC
In this version some configuration changes were done to marlin 1.1, including the LCD screen layout,
no heating, probe functionalit.
